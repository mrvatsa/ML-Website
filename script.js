...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function simulateTestCaseSteps(steps, delays, callback) {
        ...
        function executeNextStep() {
            if (index < steps.length) {
                ...
                setTimeout(callback, 2000); // Optional callback after all steps, default delay of 2 seconds
            }
        }
    ...
    function testCase1() {
        ...
        simulateTestCaseSteps(steps, monitorGenerators);
    }
    ...
    function testCase2() {
        ...
        const delays = [2000, 4000, 3000, 2000, 2000, 4000, 6000, 3000];
    
        // Simulate steps with delays and monitor generators at the end
        simulateTestCaseSteps(steps, delays, monitorGenerators);
    }
